...
@section('konten')
    <main>
        <section class="poster-sam">
            ...
            <div class="sam-ket">
                <h2 class="judul">SAMBUTAN KEPALA SEKOLAH</h2>
                <p class="des">Madrasah Aliah AL-IHSAN</p>
            </div>
        </section>

        <section class="sambutan-isi">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="sambutan-inti">
                            <div class="wrapper-sam">
                                @if (empty($data->foto))
                                    <img src="" class="image-sambutan" alt="">
                                @else
                                    <img src="/storage/{{ $data->foto }}" class="image-sambutan" alt="">
                                @endif
                                <h2 class="judul-sambutan">Sambutan Kepala Sekolah <br> Madrasah Aliah <b
                                        class="em">AL-IHSAN</b></h2>
                                <hr class="garis-sambutan">
                                @if (!empty($data->isi))
                                    <p class="isi-sambutan">
                                        Assalamualaikum Wr.Wb
                                    </p>
                                @endif
                                <p class="isi-sambutan ck">
                                    @if (!empty($data->isi))
                                        {!! $data->isi !!}
                                    @else
